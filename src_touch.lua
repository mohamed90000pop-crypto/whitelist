...
function Library:create(options)
	...
	creditsTab:credit{Name = "By: Hv_team", Description = "UI Library Developer", Discord = "e_uhr", V3rmillion = "O2"}
	creditsTab:credit{Name = "Cracked by : Hv_team", Description = "UI Library Developer", Discord = "e_uhr", V3rmillion = "O2"}
